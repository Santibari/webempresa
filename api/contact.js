...
function buildContactEmail({ nombre, empresa, email, telefono, interes, mensaje }) {
  ...
  const interesLabels = {
    ...
    'no-seguro': 'Por definir en diagnóstico'
  }
            ...
            <td style="padding:36px;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse; background:#fafcfb; border-radius:12px; overflow:hidden; border:1px solid #e6ebe8;">
                ...
                <tr>
                  ...
                  <td style="padding:14px 18px; font-size:14px; font-weight:700; color:#15181a; border-bottom:1px solid #e6ebe8;">${empresa || 'Sin empresa'}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style="padding:14px 18px; font-size:14px; color:#15181a; font-weight:600; border-bottom:1px solid #e6ebe8;">
                    <a href="tel:${telefono}" style="color:#15181a; text-decoration:none;">${telefono || 'No proporcionado'}</a>
                  </td>
                </tr>
                <tr>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto;">
                      <tr>
                        <td style="padding:0 6px;">
                          <a href="mailto:${email}?subject=Respuesta%20Aikata%20-%20Consultor%C3%ADa%20para%20${encodeURIComponent(empresa || nombre)}"
  ...
  try {
    ...
    if (!pass) {
      return res.status(500).json({
        ok: false,
        message: 'GMAIL_APP_PASSWORD no está configurado en las variables de entorno de Vercel.'
      })
    }
    ...
    const { html, text } = buildContactEmail({ nombre, empresa, email, telefono, interes, mensaje })
    ...
    console.error('Error al enviar correo en Vercel Serverless Function:', error)
    return res.status(500).json({
      ok: false,
